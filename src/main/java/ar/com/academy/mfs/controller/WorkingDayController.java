...
public class WorkingDayController {
	...
	public ResponseEntity<?> getAllUserMetrics(@PathVariable int user_id){
		...
		// Obtengo los workingDay de todo el año
		Date start = Date.valueOf("2019-01-01");
		Date end = Date.valueOf("2019-12-31");
		List<WorkingDay> workingDays = workingDayRepository.findByWorkingDateBetweenAndUser(user.getUser_id(), start, end);		
		List<Metricas> metricas = new ArrayList<Metricas>();
		
		float sociosEnero = 0, sociosFebrero = 0, sociosMarzo = 0, sociosAbril = 0, sociosMayo = 0, sociosJunio = 0, sociosJulio = 0, sociosAgosto = 0, sociosSep = 0, sociosOct = 0,sociosNov = 0, sociosDic = 0;
		float montoEnero = 0, montoFebrero = 0, montoMarzo = 0, montoAbril = 0, montoMayo = 0, montoJunio = 0, montoJulio = 0, montoAgosto = 0, montoSep = 0, montoOct = 0, montoNov = 0, montoDic = 0;
		float horasEnero = 0, horasFebrero = 0, horasMarzo = 0, horasAbril = 0, horasMayo = 0, horasJunio = 0, horasJulio = 0, horasAgosto = 0, horasSep = 0, horasOct = 0, horasNov = 0, horasDic = 0;
		float sociosHoraEnero = 0, sociosHoraFebrero = 0, sociosHoraMarzo = 0, sociosHoraAbril = 0, sociosHoraMayo = 0, sociosHoraJunio = 0, sociosHoraJulio = 0, sociosHoraAgosto = 0, sociosHoraSep = 0, sociosHoraOct = 0, sociosHoraNov = 0, sociosHoraDic = 0;
